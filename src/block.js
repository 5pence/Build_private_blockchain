    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                if (self.height === 0) {
                    console.log('block, getBData: Genesis requested')
                    reject('This is Genesis block.')
                }
                // We got past the if genesis check so resolve non-genesis block
                console.log('block, getBData: ', decodedDataJSON.data);
